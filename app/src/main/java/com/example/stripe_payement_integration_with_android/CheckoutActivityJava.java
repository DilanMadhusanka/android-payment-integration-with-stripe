...
public class CheckoutActivityJava extends AppCompatActivity {
    ...
    private static final String BACKEND_URL = "http://192.168.1.100:4242/";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        stripe = new Stripe(
                ...
                Objects.requireNonNull("pk_test_51J3b56EG6ktZBYhEDRQXpmwOR5mpZ2j8h8ejaMmYPWAWKHzjqYykGbkDewobu59dJX5pHVJnsmgjm3RRrcufGNwt00qJTK7feZ")
        );
        startCheckout();
    }
    ...
    private void startCheckout() {
        ...
        double amount = Double.valueOf(textViewAmount.getText().toString()) * 100;
